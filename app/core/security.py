...
async def get_current_user(token: str = Depends(oauth2_scheme)) -> dict:
    """Security Dependency globally injected across logic routes."""
    ...
    try:
        ...
        # Minimal extraction object (the actual DB query logic runs natively mapping sub bounds implicitly)
