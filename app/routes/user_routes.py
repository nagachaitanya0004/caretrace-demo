...
from app.schemas.user_schema import UserCreate, UserProfileUpdate, UserResponse
...
async def update_user(user_id: str, user: UserProfileUpdate, current_user: dict = Depends(get_current_user)):
    if user_id != current_user["id"]:
